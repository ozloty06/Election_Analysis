...
total_votes = 0
# Candidate Options and Declare empty dictionary for candidate vote tally.
candidate_options = []
candidate_votes = {}
...
with open(file_to_load) as election_data:
    ...
    for row in file_reader:
        ...
        # If the candidate does not match any exisitng candidate, add to the candidate list
